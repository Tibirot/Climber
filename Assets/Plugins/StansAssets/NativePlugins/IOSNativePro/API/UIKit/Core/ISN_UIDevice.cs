...
namespace SA.iOS.UIKit
{
    ...
    { 
        ...
        [SerializeField] string m_model;
        [SerializeField] string m_localizedModel;
        [SerializeField] string m_systemVersion;
        [SerializeField] ISN_UIUserInterfaceIdiom m_userInterfaceIdiom;

        [SerializeField] string m_identifierForVendor;

        //Addtional fileds
        [SerializeField] int m_majorIOSVersion;
