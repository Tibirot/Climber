...
namespace SA.iOS.ReplayKit.Internal
{
    ...
    [DllImport ("__Internal")] static extern void _ISN_SetMicrophoneEnabled(bool enabled);
        ...
        Action<ISN_PRPreivewResult> m_shareDialogCallback = delegate { };
        public void ShowVideoShareDialog(Action<ISN_PRPreivewResult> callback) {
        ...
        void OnShareDialogResult(string data) {
            var result = JsonUtility.FromJson<ISN_PRPreivewResult>(data);
