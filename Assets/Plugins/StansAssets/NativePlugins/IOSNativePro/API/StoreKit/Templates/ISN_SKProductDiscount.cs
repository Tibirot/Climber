...
namespace SA.iOS.StoreKit
{
	...
	public class ISN_SKProductDiscount 
	{
        ...
        [SerializeField] ISN_NSLocale m_priceLocale;

		[SerializeField] ISN_SKPaymentMode m_paymentMode;

		//Getting the Discount Duration
		[SerializeField] int m_numberOfUnits;
		[SerializeField] ISN_SKProductSubscriptionPeriod m_subscriptionPeriod;
