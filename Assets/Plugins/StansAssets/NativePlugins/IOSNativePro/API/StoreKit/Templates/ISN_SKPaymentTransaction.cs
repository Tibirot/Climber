...
namespace SA.iOS.StoreKit 
{
    ...
    public class ISN_SKPaymentTransaction : SA_Result
    {
        ...
        [SerializeField] string m_productIdentifier;
        [SerializeField] string m_transactionIdentifier;
        [SerializeField] long m_unitxDate;
        [SerializeField] ISN_SKPaymentTransactionState m_state;
        [SerializeField] ISN_SKPaymentTransaction m_originalTransaction;
