...
namespace SA.Android.App {
    ...
    public static class AN_NotificationManager
    {
        ...
        private static SA_Event<AN_NotificationRequest> s_onNotificationClick = null;
        private static SA_Event<AN_NotificationRequest> s_onNotificationReceived = null;
        ...
        /// <summary>
        /// Unschedules the specified notification request.
        /// </summary>
        /// <param name="request">request to Unshedule.</param>
        public static void Unschedule(AN_NotificationRequest request) {
            Unschedule(request.Identifier);
        }

        /// <summary>
        /// Unschedules the specified notification request by id
        /// </summary>
        /// <param name="Identifier">notification request id</param>
        ...
        /// Make sence to check this filed value on your app start. Before you subscribe to <see cref="OnNotificationClick"/>
        /// 
        ...
        /// <summary>
        /// The event is fired when user clicked on loal notification banner
        /// </summary>
        ...
        private static void ValidateRequest(AN_NotificationRequest request) {
            ...
            //Skiping for the Andrid varsions that does not support notification chanels
            ...
            //1 if you spesifayed channel that doesn't yet exists
            //2 fall back to default chnannel, that shoudl always be updated accodring to a builder settings
