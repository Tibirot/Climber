...
namespace SA.Android.App {
    ...
    public class AN_PermissionsManager 
    {
        ...
        /// <param name="callback">Results of permission requests will be delivererd vai this callback </param>
        public static void RequestPermission(AMM_ManifestPermission permission, Action<AN_PermissionsRequestResult> callback) {
            RequestPermissions(new AMM_ManifestPermission[] { permission }, callback);
        }
        ...
        public static void RequestPermissions(AMM_ManifestPermission[] permissions, Action<AN_PermissionsRequestResult> callback) {
            ...
            if (Application.isEditor) {
                ...
                foreach (AMM_ManifestPermission perm in permissions) {
                    var responce = new AN_PermissionsRequestResponce(perm, AN_PackageManager.PermissionState.Granted);
                    result.AddResponce(responce);
                }
