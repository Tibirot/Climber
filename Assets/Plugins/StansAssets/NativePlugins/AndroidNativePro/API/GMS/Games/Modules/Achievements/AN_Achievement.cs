...
namespace SA.Android.GMS.Games
{
    ...
    public class AN_Achievement
    {
        ...
        [SerializeField] string m_unlockedImageUri;

        [SerializeField] int m_currentSteps;
        [SerializeField] int m_totalSteps;
        [SerializeField] int m_type;
        [SerializeField] int m_state;
        [SerializeField] long m_xpValue;
