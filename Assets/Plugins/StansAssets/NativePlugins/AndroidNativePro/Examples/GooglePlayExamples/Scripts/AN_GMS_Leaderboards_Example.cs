...
public class AN_GMS_Leaderboards_Example : MonoBehaviour {
   ...
   // private string leaderboardsId = "CgkI0Y2kiIAVEAIQBw";
    ...
    [SerializeField] Button m_nativeUI;
    [SerializeField] Button m_loadLeaberboards;
    [SerializeField] Button m_loadOneLeaberboard;

    [SerializeField] Button m_sbmit;
    [SerializeField] Button m_sbmitNoCB;

    [SerializeField] Button m_loadScores;
