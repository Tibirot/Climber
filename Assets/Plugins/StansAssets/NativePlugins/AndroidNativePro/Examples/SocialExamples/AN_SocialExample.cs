...
public class AN_SocialExample : MonoBehaviour {
    ...
    [SerializeField] Button m_shareText;
    [SerializeField] Button m_shareImage;
    [SerializeField] Button m_shareImages;

    [SerializeField] Button m_fbImage;
    [SerializeField] Button m_fbImages;

    [SerializeField] Button m_instaImage;
    [SerializeField] Button m_instaImages;

    [SerializeField] Button m_emil;

    [SerializeField] Button m_twitter;
    [SerializeField] Button m_whatsup;

    [SerializeField] Button m_instllCheck;
    [SerializeField] Button m_startFacebook;

    [SerializeField] Button m_composeSMS;
